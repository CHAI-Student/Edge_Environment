...
실행:
    pytest tests/test_advanced_scenarios.py -v
"""
...
from ..weight.multi_zone_monitor import MultiZoneWeightMonitor
...
@pytest.fixture
def return_detector():
    return ReturnDetector(match_tolerance=0.15, return_window=30.0)


@pytest.fixture
def event_tracker():
    return EventTracker(settling_time=2.0, return_window=30.0)
